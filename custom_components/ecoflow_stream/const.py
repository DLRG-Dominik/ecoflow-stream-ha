...
IGNORED_PARAMS = {
    ...
    "iotLan2LastRecvDataTime", "invStateMonitor1", "dabStateMonitor1",
    ...
    "iinPv1", "iinPv3", "iinPv4", "ioutBat", "pinPv1", "pinPv2", "pinPv3", "pinPv4",
    "vinPv2", "vinPv4", "pvIoutFilt", "bmsChgReqCurr",
